      ...
      <main className="flex-1">
        <section className="container-page flex flex-col items-center py-24 text-center sm:py-32">
          ...
          <p className="mt-6 max-w-2xl text-lg text-surface-500 dark:text-surface-400">
            Receive instant micro-payments from supporters globally using the Stellar blockchain. No
            middlemen. No delays. Just pure creator support.
          </p>
        ...
        <section className="bg-primary-600 py-16 text-white">
          <div className="container-page grid gap-8 text-center sm:grid-cols-3">
            <div>
              ...
              <p className="mt-1 text-sm text-primary-100">Average transaction fee</p>
            </div>
            <div>
              <p className="text-4xl font-bold">5s</p>
              <p className="mt-1 text-sm text-primary-100">Settlement time</p>
            </div>
            <div>
              <p className="text-4xl font-bold">Global</p>
              <p className="mt-1 text-sm text-primary-100">Reach supporters worldwide</p>
            </div>
          </div>
        </section>
      </main>
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-2.36a4.5 4.5 0 00-6.364 0l-4.5 4.5a4.5 4.5 0 002.475 7.652"
        />
      </svg>
    ),
  },
